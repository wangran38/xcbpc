...
const agentApply = (data) => {
  return request("/api/agentuser/add", "POST", data);
};

export { agentApply as a, citytree as b, citylist as c, getShopGoods as d, getShopComments as g, marketlist as m, shopList as s };
//# sourceMappingURL=shopping-COjTdxXM.mjs.map
