...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "site-header" }, _attrs))} data-v-ee1d35fc><div class="header-container" data-v-ee1d35fc><div class="header-logo" data-v-ee1d35fc><img${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "width": "50px", "height": "50px", "margin-right": "10px" })}" data-v-ee1d35fc><a href="/" class="logo-link" data-v-ee1d35fc><span class="logo-text" data-v-ee1d35fc>\u6D77\u5357\u79EF\u5206\u5B9D\u7535\u5B50\u5546\u52A1\u6709\u9650\u516C\u53F8</span></a></div><nav class="desktop-nav" data-v-ee1d35fc><ul class="nav-list" data-v-ee1d35fc><!--[-->`);
      ssrRenderList(navItems, (item) => {
        _push(`<li class="nav-item" data-v-ee1d35fc><a${ssrRenderAttr("href", item.url)} class="nav-link"${ssrRenderAttr("target", item.target)} data-v-ee1d35fc>${ssrInterpolate(item.label)}</a></li>`);
      });
      _push(`<!--]--></ul></nav><button class="mobile-menu-btn" aria-label="\u5207\u6362\u83DC\u5355" data-v-ee1d35fc><img${ssrRenderAttr("src", _imports_1)} alt="\u83DC\u5355\u56FE\u6807" class="menu-icon" data-v-ee1d35fc></button></div><div class="${ssrRenderClass([{ "mobile-nav--open": isMenuOpen.value }, "mobile-nav"])}" style="${ssrRenderStyle({ opacity: menuOpacity.value })}" data-v-ee1d35fc><ul class="mobile-nav-list" data-v-ee1d35fc><!--[-->`);
      ssrRenderList(navItems, (item) => {
        _push(`<li class="mobile-nav-item" data-v-ee1d35fc><a${ssrRenderAttr("href", item.url)} class="mobile-nav-link"${ssrRenderAttr("target", item.target)} data-v-ee1d35fc>${ssrInterpolate(item.label)}</a></li>`);
      });
      _push(`<!--]--></ul></div></header>`);
    };
  }
...
const headerVue = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ee1d35fc"]]);
const _sfc_main = {};
...
//# sourceMappingURL=footers-bgG5dM_J.mjs.map
